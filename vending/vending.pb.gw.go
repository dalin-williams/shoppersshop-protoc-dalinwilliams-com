...
func request_SHOPPERSSHOP_VendingMachineService_PayDeleteItemFromCart_0(ctx context.Context, marshaler runtime.Marshaler, client SHOPPERSSHOP_VendingMachineServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq PayDeleteItemFromCartRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.PayDeleteItemFromCart(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err
...
func RegisterSHOPPERSSHOP_VendingMachineServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client SHOPPERSSHOP_VendingMachineServiceClient) error {
	...
	mux.Handle("DELETE", pattern_SHOPPERSSHOP_VendingMachineService_PayDeleteItemFromCart_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		if cn, ok := w.(http.CloseNotifier); ok {
			go func(done <-chan struct{}, closed <-chan bool) {
		...
		resp, md, err := request_SHOPPERSSHOP_VendingMachineService_PayDeleteItemFromCart_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_SHOPPERSSHOP_VendingMachineService_PayDeleteItemFromCart_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	...
	pattern_SHOPPERSSHOP_VendingMachineService_PayDeleteItemFromCart_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"vending", "v1", "pay", "purchase", "id"}, ""))
...
var (
	...
	forward_SHOPPERSSHOP_VendingMachineService_PayDeleteItemFromCart_0 = runtime.ForwardResponseMessage
